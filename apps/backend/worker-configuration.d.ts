/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareBindings` (hash: 0ad32395ee9206d5b9d80da042f85752)
// Runtime types generated with workerd@1.20260616.1 2026-06-19 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	MATCH_DIRECTORY: D1Database;
	FRONTEND_ORIGIN: "https://frontend.tomop0513-maey.workers.dev";
	GAME_MATCH: DurableObjectNamespace<import("./src/index").GameMatch>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "GameMatch";
	}
